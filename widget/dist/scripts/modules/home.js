...
/***/ function(module, exports, __webpack_require__) {
	...
	document.addEventListener('apiready', function () {
	  (0, _methods.openFrame)('home_home');
	  initEvent();
	  ...
	  new Vue({
	    ...
	    methods: {
	      onClickSubmit: function onClickSubmit() {
	        (0, _methods.openFrame)('home_mask', {
	          bgColor: '',
	          animation: {
	            type: 'fade'
	          },
	        ...
	        var winHeight = (0, _attributes2.default)('winHeight');
	        var modalHeight = 400;
	        (0, _methods.openFrame)('home_submit', {
	          bgColor: '',
	          animation: {
	            type: 'movein',
	            subType: "from_bottom"
	...
	function initEvent() {
	  (0, _methods.addEvent)('closeFrame', function (e) {
	    (0, _methods.closeFrame)('home_mask');
	    (0, _methods.animation)('home_submit', {
	      translation: {
	        y: 400
	      },
	      duration: 300,
	      ...
	      return (0, _methods.closeFrame)('home_submit');
	    });
	  });
	}

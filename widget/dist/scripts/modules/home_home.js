...
/***/ function(module, exports, __webpack_require__) {
	...
	var _methods = __webpack_require__(309);
	...
	document.addEventListener('apiready', function () {
	  new Vue({
	    ...
	    created: function created() {
	      ...
	      (0, _methods.setReflash)(function () {
	        return getHomeData.call(_this);
	      });
	    }
	  });
	});
	...
	function getHomeData() {
	  ...
	  (0, _utils.parallel)({
	    ranking: function ranking(cb) {
	      (0, _api.getHomeRanking)().then(function (rankings) {
	        return cb('', rankings);
	      }).catch(function (err) {
	        return cb(err);
	      });
	    },
	    helps: function helps(cb) {
	      (0, _api.getHomeHelp)().then(function (helps) {
	        return cb('', helps);
	      }).catch(function (err) {
	        return cb(err);
	      });
	    },
	    services: function services(cb) {
	      (0, _api.getHomeService)().then(function (services) {
	        return cb('', services);
	      }).catch(function (err) {
	        return cb(err);
	      });
	    },
	    news: function news(cb) {
	      (0, _api.getHomeNews)().then(function (news) {
	        return cb('', news);
	      }).catch(function (err) {
	        return cb(err);
	      });
	    ...
	    _this2.skillRankings = res.ranking;
	    _this2.helps = res.helps;
	    _this2.services = res.services;
	    _this2.news = res.news;
	  }).catch(function (err) {
	    return alert(err);
	  }).then(function (res) {
	    return (0, _methods.setReflashDone)();
	  });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// polyfill
	window.log = _utils.log;
	document.body.addEventListener('touchstart', function () {});

	// 以事件替换原生 apiready 方法
	var apireadyEvent = new CustomEvent('apiready');
	window.apiready = function () {
	  document.dispatchEvent(apireadyEvent);
	  // 实现沉浸式
	  (0, _utils.fixStatusBar)();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.log = exports.storage = exports.parallel = exports.fixStatusBar = undefined;
	...
	var _parallel = __webpack_require__(308);
	...
	function fixIos7Bar() {
	  var strDM = (0, _attributes2.default)('systemType');
	  if (strDM === 'ios') {
	    var numSV = parseInt((0, _attributes2.default)('systemVersion'), 10);
	    var fullScreen = (0, _attributes2.default)('fullScreen');
	    var iOS7StatusBarAppearance = (0, _attributes2.default)('iOS7StatusBarAppearance');
	    if (numSV >= 7 && !fullScreen && iOS7StatusBarAppearance) {
	      getHeader().style.paddingTop = '20px';
	      _storage2.default.setItem('config_statusbar_height', '20px');
	    }
	  }
	}
	...
	function fixStatusBar() {
	  ...
	  if (!$header) return;
	  var cacheHeight = _storage2.default.getItem('config_statusbar_height');
	  if (cacheHeight) {
	    getHeader().style.paddingTop = cacheHeight;
	    return;
	  }
	  var sysType = (0, _attributes2.default)('systemType');
	  if (sysType === 'ios') {
	    fixIos7Bar();
	  } else if (sysType === 'android') {
	    var ver = parseFloat((0, _attributes2.default)('systemVersion'));
	    if (ver >= 4.4) {
	      $header.style.paddingTop = '25px';
	      _storage2.default.setItem('config_statusbar_height', '25px');
	    }
	  }
	}
	...
	exports.fixStatusBar = fixStatusBar;
...
/***/ function(module, exports) {
	...
	exports.default = function (attribute) {
	  if (!attributeNames.includes(attribute)) throw new Error('invalid attribute: ' + attribute);
	  return api[attribute];
	};

	var attributeNames = ['appId', 'appName', 'appVersion', 'systemType', 'systemVersion', 'version', 'deviceId', 'deviceToken', 'deviceModel', 'deviceName', 'operator', 'connectionType', 'fullScreen', 'screenWidth', 'screenHeight', 'winName', 'winWidth', 'winHeight', 'frameName', 'frameWidth', 'frameHeight', 'pageParam', 'wgtParam', 'appParam', 'statusBarAppearance', 'wgtRootDir', 'fsDir', 'cacheDir', 'boxDir', 'debug', 'channel', 'iOS7StatusBarAppearance'];
...
/***/ function(module, exports) {
	...
	var HEADER_HEIGHT = exports.HEADER_HEIGHT = 45;
	var FOOTER_HEIGHT = exports.FOOTER_HEIGHT = 50;
	var ANDROID_STATUSBAR_HEIGHT = exports.ANDROID_STATUSBAR_HEIGHT = 25;
	var IOS_STATUSBAR_HEIGHT = exports.IOS_STATUSBAR_HEIGHT = 20;
	var WIN_ANIMATION_DURATION = exports.WIN_ANIMATION_DURATION = 300;
	var REQUEST_TIMEOUT = exports.REQUEST_TIMEOUT = 30;
	var CDN = exports.CDN = '';
	var HOST = exports.HOST = 'http://192.168.1.108:3000';
	...
	exports.default = function () {
	  ...
	  return new Promise(function (resolve, reject) {
	    ...
	    keys.forEach(function (key) {
	      return tasks[key](function (err, payload) {
	        return singleCb(err, payload, key);
	      });
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.request = exports.dispatchEvent = exports.removeEvent = exports.addEvent = exports.setReflashDone = exports.setReflash = exports.rebootApp = exports.removeLaunchView = exports.execScript = exports.animation = exports.setWinAttr = exports.closeToWin = exports.closeWin = exports.openWin = exports.setFrameGroupAttr = exports.setFrameGroupIndex = exports.closeFrameGroup = exports.openFrameGroup = exports.setFrameClient = exports.sendFrameToBack = exports.bringFrameToFront = exports.setFrameAttr = exports.closeFrame = exports.openFrame = undefined;

	var _frame = __webpack_require__(310);

	var _win = __webpack_require__(311);

	var _others = __webpack_require__(312);

	var _request = __webpack_require__(313);

	var _request2 = _interopRequireDefault(_request);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.openFrame = _frame.openFrame;
	exports.closeFrame = _frame.closeFrame;
	exports.setFrameAttr = _frame.setFrameAttr;
	exports.bringFrameToFront = _frame.bringFrameToFront;
	exports.sendFrameToBack = _frame.sendFrameToBack;
	exports.setFrameClient = _frame.setFrameClient;
	exports.openFrameGroup = _frame.openFrameGroup;
	exports.closeFrameGroup = _frame.closeFrameGroup;
	exports.setFrameGroupIndex = _frame.setFrameGroupIndex;
	exports.setFrameGroupAttr = _frame.setFrameGroupAttr;
	exports.openWin = _win.openWin;
	exports.closeWin = _win.closeWin;
	exports.closeToWin = _win.closeToWin;
	exports.setWinAttr = _win.setWinAttr;
	exports.animation = _others.animation;
	exports.execScript = _others.execScript;
	exports.removeLaunchView = _others.removeLaunchView;
	exports.rebootApp = _others.rebootApp;
	exports.setReflash = _others.setReflash;
	exports.setReflashDone = _others.setReflashDone;
	exports.addEvent = _others.addEvent;
	exports.removeEvent = _others.removeEvent;
	exports.dispatchEvent = _others.dispatchEvent;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.setFrameAttr = setFrameAttr;
	exports.bringFrameToFront = bringFrameToFront;
	exports.sendFrameToBack = sendFrameToBack;
	exports.setFrameClient = setFrameClient;
	exports.openFrameGroup = openFrameGroup;
	exports.closeFrameGroup = closeFrameGroup;
	exports.setFrameGroupIndex = setFrameGroupIndex;
	exports.setFrameGroupAttr = setFrameGroupAttr;
	...
	function openFrame(name) {
	  ...
	  var system = (0, _attributes2.default)('systemType');
	  var statusBarHeight = system === 'ios' ? _config.IOS_STATUSBAR_HEIGHT : _config.ANDROID_STATUSBAR_HEIGHT;
	  var footerHeight = _config.FOOTER_HEIGHT;
	  var headerHeight = _config.HEADER_HEIGHT + statusBarHeight;
	  var contentHeight = opts.nofooter ? (0, _attributes2.default)('winHeight') - headerHeight : (0, _attributes2.default)('winHeight') - headerHeight - footerHeight;
	...
	function setFrameAttr(opts) {
	  api.setFrameAttr(opts);
	}

	function bringFrameToFront(fromName, toName) {
	...
	function sendFrameToBack(fromName, toName) {
	  api.sendFrameToBack({
	    fromName: fromName,
	    toName: toName
	  });
	...
	function setFrameClient(name, cb) {
	  api.setFrameClient({
	    frameName: name
	  }, cb);
	}

	function openFrameGroup(name, subNames) {
	  ...
	  var footerHeight = _config.FOOTER_HEIGHT;
	  var headerHeight = _config.HEADER_HEIGHT + statusBarHeight;
	  var contentHeight = api.winHeight - headerHeight - footerHeight;
	  var frames = subNames.map(function (name) {
	    return { name: name, url: name + '.html', bgColor: '#fff' };
	  });
	...
	function setFrameGroupAttr(name, opts) {
	  api.setFrameGroupAttr(_extends({
	    name: name
	  }, opts));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.closeToWin = closeToWin;
	exports.setWinAttr = setWinAttr;
	...
	function openWin(name) {
	  ...
	  api.openWin({
	    ...
	    animation: {
	      type: 'movein',
	      subType: "from_right",
	      duration: _config.WIN_ANIMATION_DURATION
	    }
	  });
	}
...
/***/ function(module, exports) {
	...
	exports.removeLaunchView = removeLaunchView;
	exports.rebootApp = rebootApp;
	exports.setReflash = setReflash;
	exports.setReflashDone = setReflashDone;
	exports.addEvent = addEvent;
	exports.removeEvent = removeEvent;
	exports.dispatchEvent = dispatchEvent;
	function animation(name, opts, cb) {
	  api.animation(_extends({
	    name: name
	  }, opts), cb);
	}

	function execScript(name, frameName, script) {
	  api.execScript({
	    name: name,
	    frameName: frameName,
	    script: script
	...
	function dispatchEvent(eventName, extra) {
	  api.sendEvent({
	    name: eventName,
	    extra: extra
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getHomeNews = exports.getHomeService = exports.getHomeHelp = exports.getHomeRanking = undefined;

	var _methods = __webpack_require__(309);

	var _config = __webpack_require__(306);

	var getHomeRanking = exports.getHomeRanking = function getHomeRanking() {
	  return _methods.request.get(_config.HOST + '/home/ranking');
	};
	var getHomeHelp = exports.getHomeHelp = function getHomeHelp() {
	  return _methods.request.get(_config.HOST + '/home/help');
	};
	var getHomeService = exports.getHomeService = function getHomeService() {
	  return _methods.request.get(_config.HOST + '/home/service');
	};
	var getHomeNews = exports.getHomeNews = function getHomeNews() {
	  return _methods.request.get(_config.HOST + '/home/news');
	};
